...
void ModificacionSectorEmpleado(eEmpleado vec[], int tamsec);
...
int main()
{
    ...
    do
    {
        ...
        case 4:
            //printf("\nModificar por sector\n\n");
            ModificacionSectorEmpleado(sectores,TAMSEC);
            system("pause");
            break;
...
int menu()
{
    ...
    printf("3- Modificacion sueldo de empleado\n");
    printf("4- Modificacion sector de empleado\n");
    printf("5- Ordenar Empleados\n");
    printf("6- Listar Empleados\n");
    printf("7- Listar Sectores con Empleados\n");
    printf("8- Cantidad de empleados por sector\n");
    printf("9- Sectores con mas empleados\n");
    printf("10- Salir\n\n");
...
void ModificacionSectorEmpleado(eEmpleado vec[], int tamsec){
    ...
    esta = buscarEmpleado(vec, tamsec, sector);

    if( esta == -1){

        printf("\nEl sector %d no esta registrado en el sistema\n", sector);
    }
    else{
